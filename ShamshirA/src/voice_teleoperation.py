...
class RobotVoiceTeleop:
    ...
    def  __init__(self):
        ...
        # Publish the Twist message to the /mobile_base/commands/velocity topic
        ...
        #I consider the following simple commands, which you can extend on your own
        self.commands =             ['stop',
                                'forward',
                                'backward',
                                'left',
        ...
        # I have to keep publishing the velocity message if we want the robot to keep moving.
